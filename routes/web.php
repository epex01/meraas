...
Route::get('/sponor', function () {
    return view('Front.sponor');
})->name('sponor');


Route::get('/sedra', function () {  
    return view('Front.sedra');
})->name('sedra');
Route::get('/alarous', function () {  
    return view('Front.alarous');
})->name('alarous');
Route::get('/warefa', function () {  
    return view('Front.warefa');
})->name('warefa');
Route::get('/almanar', function () {  
    return view('Front.almanar');
})->name('almanar');
Route::get('/aldanah', function () {  
    return view('Front.aldanah');
})->name('aldanah');
...
Route::get('/marafy', function () { 
    return view('Front.marafy');
})->name('marafy');
Route::get('/meera_front', function () { 
    return view('Front.meera_front');
})->name('meera_front');
Route::get('/stadium', function () { 
    return view('Front.stadium');
})->name('stadium');
Route::get('/next', function () { 
    return view('Front.next');
})->name('p_next');
